...
<body>
  <header>
    <title>Women's Clothing | Buy Cultural Fashion Online USA</title>
  ...
  <main>
    ...
    <!-- Items -->
    <div class="container">
      <p class="center-align" id="new-title-text">- Women's Clothing -</p>
    ...
    $query = "SELECT * FROM women ORDER by id DESC LIMIT " . $viewItems;
